...
class CodingVideo:
    ...
    def get_frame_rgb_array(self, frame_number: int) -> np.ndarray:
        ...
        Reference
        ---------
        https://docs.opencv.org/4.x/dd/d49/tutorial_py_contours.html
    ...
    def save_as_image(self, seconds: int, output_path: Path | str = 'output.png') -> None:
        ...
        This uses OpenCV to convert the extracted frame ndarray into a PNG file.

        Reference
        ---------
        https://docs.opencv.org/4.x/d8/dbc/tutorial_py_image_display.html
        """
